...
export function OffersTable({ offers, top, loading, queried, error, acquiringOfferId, serviceName, emptyText, onAcquire }: OffersTableProps) {
      ...
      <div className="rounded-xl border border-border bg-card">
        ...
        <Table>
          ...
          <TableBody>
            ...
            {!queried && <TableRow><TableCell colSpan={8}><EmptyBlock text={emptyText} /></TableCell></TableRow>}
          </TableBody>
        </Table>
      </div>
    </div>
